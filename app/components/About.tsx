...
const About = () => {
  return (
    <div className='grid grid-cols-2 p-10 bg-main-white'>
        <div className='p-10 h-[30rem]'>
            <h3 className='text- text-3xl font-pop font-semibold bg-gradient-to-r from-main-red to-main-green via-main-green bg-clip-text text-transparent drop-shadow-sm'>Wright Travels &amp; Tours </h3>
            <p className='text-2xl font-pop'>Why Book With Wright Travels</p>
